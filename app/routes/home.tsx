...
export function meta(_: Route.MetaArgs) {
  return [
    { title: "Александр Курчаков — портфолио" },
    {
      name: "description",
      content:
        "Александр Курчаков — fullstack-разработчик и UX/UI-дизайнер из Алматы. React, Next.js, TypeScript, Web3 — плюс айдентика, игры и видео.",
    },
    { property: "og:title", content: "Александр Курчаков — портфолио" },
    {
      property: "og:description",
      content:
        "Fullstack-разработчик и UX/UI-дизайнер из Алматы. Сайты, игры, айдентика и видео.",
    },
