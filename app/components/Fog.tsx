...
void main(){
  ...
  // Общая плотность. Держим низкой намеренно: пелена должна угадываться, а не
  // заволакивать карточки. Была 0.40 — при этом дым лез поверх контента.
  float a=(0.42+0.58*f)*vert*0.065;
  a*=1.0-mi*0.5;
